...
<style>
    ...
    html[data-theme="dark"] input,html[data-theme="dark"] select { background:#1a2744; color:#e2e8f0; border-color:rgba(255,255,255,0.1); }
...
<div class="fo-topbar">
    ...
    <?php
        // include global window controls (minimize / reduce / close) for FO pages
        if (file_exists(__DIR__ . '/window_controls.php')) {
            require __DIR__ . '/window_controls.php';
        }
    ?>
...
<script src="<?php echo $_assetsBase; ?>/js/voice-search.js" defer></script>
