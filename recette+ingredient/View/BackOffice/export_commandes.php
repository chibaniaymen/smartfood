...
$cmdPath = __DIR__ . '/../../Controller/CommandeController.php';
if (file_exists($cmdPath)) include_once $cmdPath;
if (!class_exists('CommandeController')) { http_response_code(410); echo 'Commandes feature not available.'; exit; }
