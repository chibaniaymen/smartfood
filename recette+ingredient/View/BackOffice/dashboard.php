...
$controllerFiles = [
    'MarathonController' => __DIR__ . '/../../Controller/MarathonController.php',
    'ParcoursController' => __DIR__ . '/../../Controller/ParcoursController.php',
    'UserController' => __DIR__ . '/../../Controller/UserController.php',
    'CommandeController' => __DIR__ . '/../../Controller/CommandeController.php',
    'LigneCommandeController' => __DIR__ . '/../../Controller/LigneCommandeController.php',
    'StandController' => __DIR__ . '/../../Controller/StandController.php',
    'ProduitController' => __DIR__ . '/../../Controller/ProduitController.php',
];
foreach ($controllerFiles as $class => $path) {
    if (file_exists($path)) require_once $path;
}
$legacyBroken = !class_exists('MarathonController') || !class_exists('ParcoursController') || !class_exists('CommandeController') || !class_exists('LigneCommandeController') || !class_exists('StandController') || !class_exists('ProduitController');
if ($legacyBroken) {
    echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>Back Office</title></head><body>';
    echo '<h2>Back Office — fonctions supprimées</h2>';
    echo '<p>Certaines fonctionnalités (marathons, parcours, stands, produits, commandes) ont été retirées du projet. Le backoffice doit être adapté.</p>';
    echo '<p><a href="../FrontOffice/accueil.php">Retour Front Office</a></p>';
    echo '</body></html>';
    exit;
}
...
<head>
    ...
    <title>Dashboard Admin — Recettes</title>
...
<aside class="sidebar">
    ...
    <div class="side-note">Administration Recettes — gestion des marathons, parcours et utilisateurs.</div>
</aside>
