            ...
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="adminDropdown">
                  <a class="dropdown-item" href="../BackOffice/dashboard.php">Blog Dashboard</a>
                  <a class="dropdown-item" href="../BackOffice/dashboard_view.php">Event Dashboard</a>
                </div>
              </li>
            </ul>
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="view/FrontOffice/images/o1.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tasty Thursdays
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="view/FrontOffice/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
        ...
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f1.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f2.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Burger
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f3.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f4.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
          ...
          <div class="col-sm-6 col-lg-4 all fries">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f5.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    French Fries
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f6.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f7.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f8.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="view/FrontOffice/images/f9.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
  ...
  <section class="food_section layout_padding">
    <div class="container">
          ...
          <?php if (!empty($events)): ?>
              ...
              <div class="col-sm-6 col-lg-4 all">
                <div class="box">
                  <div>
                    <div class="img-box">
                      <img src="view/FrontOffice/images/event_default.png" alt="<?php echo htmlspecialchars($e['title']); ?>">
                    </div>
                    <div class="detail-box">
                      <h5><?php echo htmlspecialchars($e['title']); ?></h5>
                      <p><?php echo substr(htmlspecialchars($e['description']), 0, 80); ?>...</p>
                      <div class="options">
                        <h6>
                          <?php echo $e['price'] ? '€' . $e['price'] : 'Free'; ?>
                        </h6>
                        <a href="events.php?action=show&id=<?php echo $e['id']; ?>">
                          <i class="fa fa-calendar" style="color: white;"></i> <?php echo date('M d', strtotime($e['event_date'])); ?>
                        </a>
                      </div>
                    </div>
                  </div>
      ...
      <div class="btn-box mt-4 text-center">
        <a href="myEvents.php" style="background-color: #ffbe33; color: white; padding: 10px 45px; border-radius: 45px; display: inline-block; text-decoration: none;">
          View All Events
        </a>
      </div>
    </div>
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="view/FrontOffice/images/about-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="view/FrontOffice/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="view/FrontOffice/images/client2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
