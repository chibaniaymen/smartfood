...
// Prefer the workspace root `/integ` when present to keep dashboard asset URLs stable.
$scriptName = $_SERVER['SCRIPT_NAME'] ?? '';
if (strpos($scriptName, '/integ') !== false) {
  $baseUrl .= '/integ';
} else {
...
$dashboardTarget = $currentPage === 'dashboard_view.php' ? 'dashboard.php' : 'dashboard_view.php';
$dashboardLabel = $currentPage === 'dashboard_view.php' ? 'Blog Dashboard' : 'Event Dashboard';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="<?php echo $baseUrl; ?>/view/BackOffice/<?php echo $dashboardTarget; ?>" class="logo">
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              <!-- Dashboard -->
              <li class="nav-item <?php echo in_array($currentPage, ['dashboard.php', 'dashboard_view.php']) ? 'active' : ''; ?>">
                <a href="<?php echo $baseUrl; ?>/view/BackOffice/<?php echo $dashboardTarget; ?>">
                  <i class="fas fa-home"></i>
                  <p><?php echo $dashboardLabel; ?></p>
                </a>
              </li>
