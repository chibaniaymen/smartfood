      ...
      <div class="sidebar-content">
        <ul class="nav nav-secondary">
          ...
          <li class="nav-item <?php echo $activeMenu==='dashboard' ? 'sf-active active' : ''; ?>">
            <a href="<?php echo $backPath; ?>dashboard_view.php">
          ...
          <li class="nav-item">
            <a href="<?php echo $backPath; ?>../../index.php" target="_blank">
              ...
              <ul class="dropdown-menu dropdown-user animated fadeIn">
                <div class="dropdown-user-scroll scrollbar-outer">
                  ...
                  <li>
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?php echo $backPath; ?>../../index.php" target="_blank"><i class="fas fa-external-link-alt me-2"></i>Voir le site</a>
                  </li>
                </div>
              </ul>
            </li>
