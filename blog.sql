...
('Bienvenue sur le blog SmartFood', 'Ceci est le premier article du blog. Utilisez l''espace admin pour créer, modifier ou supprimer des articles.'),
('Conseils nutrition pour bien manger', 'Partagez des idées, des recettes et des actualités santé ici. Le système supporte également les commentaires.');
